...
marking-VoxTailBalled-tail_stenciled = Tail Stenciled
marking-VoxTailBalled = Thrasher

marking-VoxTailStripes-voxtailstripes = Tail Stripes
marking-VoxTailStripes-tail_stenciled = Tail Stenciled
...
marking-VoxTailBack-voxtailcolorable = Voxtailcolorable
...
marking-VitiligoHeadL-vitiligoheadl = Vitiligoheadl
marking-VitiligoHeadL = Vitiligo (Left Eye)

marking-VitiligoHeadR-vitiligoheadr = Vitiligoheadr
marking-VitiligoHeadR = Vitiligo (Right Eye)

marking-VitiligoHeadJaw-vitiligoheadjaw = Vitiligoheadjaw
marking-VitiligoHeadJaw = Vitiligo (Jawline)

marking-VitiligoChestF-vitiligochestf = Vitiligochestf
marking-VitiligoChestF = Vitiligo Spread

marking-VitiligoChestSpots-vitiligochestspots = Vitiligochestspots
marking-VitiligoChestSpots = Vitiligo Spots

marking-VitiligoArmR-vitiligoarmr = Vitiligoarmr
marking-VitiligoArmR = Vitiligo (Right Arm)

marking-VitiligoArmL-vitiligoarml = Vitiligoarml
marking-VitiligoArmL = Vitiligo (Left Arm)

marking-VitiligoHandR-vitiligohandr = Vitiligohandr
marking-VitiligoHandR = Vitiligo (Right Hand)

marking-VitiligoHandL-vitiligohandl = Vitiligohandl
marking-VitiligoHandL = Vitiligo (Left Hand)

marking-VitiligoLegR-vitiligolegr = Vitiligolegr
marking-VitiligoLegR = Vitiligo (Right)

marking-VitiligoLegL-vitiligolegl = Vitiligolegl
